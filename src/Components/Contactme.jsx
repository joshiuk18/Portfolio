        ...
        <div className="w-full px-4">
            ...
            <div className="flex flex-col md:flex-row max-w-7xl mx-auto items-center gap-10 py-10">
                ...
                <div className="w-full md:w-1/2 text-center md:text-left order-2 md:order-1">
                    ...
                    <p className="py-4 text-base sm:text-lg md:text-xl font-light text-slate-600">
                    ...
                    <span className="flex flex-wrap justify-center md:justify-start gap-6 pt-6 text-xl sm:text-2xl md:text-3xl text-gray-700">
                ...
                <div className="w-full md:w-1/2 flex justify-center md:justify-end order-1 md:order-2">
                    <div className="w-40 h-40 sm:w-52 sm:h-52 md:w-64 md:h-64 rounded-full overflow-hidden shadow-xl border-4 border-blue-100">
            ...
            <p className="text-center text-sm sm:text-base md:text-lg font-light py-4 text-slate-600">
                Made with
